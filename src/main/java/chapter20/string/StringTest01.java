...
/*
关于java JDK中内置的一个类java.lang.String
    1、String表示字符串类型，属于引用数据类型，不属于基本数据类型
    2、在java中随便使用双引号括起来的都是String对象。例如：”abc“，”hello world“，这是3个string对象
    3、java中规定，双引号括起来的字符串是不可变的，也就是说”abc“自出生到最终死亡，不可变，不能变成”abcd“
