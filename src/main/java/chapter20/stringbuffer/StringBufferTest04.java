package chapter20.stringbuffer;
...
/*
    ...
    2、StringBuilder/StringBuffer为什么是可变的呢？
        我看过源代码，StringBuilder/StringBuffer内部实际上是一个byte[]数组，这个byte[]数组没有被final修饰，StringBuilder/StringBuffer的初始化容量我记得是16，当存满之后会进行扩容，底层调用了数组拷贝的方法System.arraycopy()...是这样扩容的。所以StringBuilder/StringBuffer适合于使用字符串的频繁拼接
 */
