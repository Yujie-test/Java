...
public class Stack { // 栈类
    ...
    // push方法（push方法压栈）
    // 压栈表示栈中多一个元素
    public void push(Object e) throws MyStackOperationException {
        if (index == this.elements.length - 1){
            ...
            // 创建异常对象
            MyStackOperationException soe = new MyStackOperationException("Stack is full, push failed!");
            // 手动将异常抛出去
            //throw soe; //这里捕捉没有意义，自己new一个异常，自己捉，没有意义。栈已满这个信息你需要传递出去

            // 合并
            throw new MyStackOperationException("Stack is full, push failed!");
    ...
    public void pop() throws MyStackOperationException {
        if (index < 0){
            ...
            //return;
            throw new MyStackOperationException("Stack is empty, pop failed!");
        }
        // 程序能执行到此处说明栈没有空
