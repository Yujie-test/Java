...
/*
    匿名内部类：
        ...
        4、匿名内部类是局部内部类的一种
            因为这个类没有名字而的名，叫做匿名内部类

        5、学习匿名内部类主要是让大家以后在阅读别人代码的时候，能够理解。并不代表以后都需要这样写。因为匿名内部类有两个缺点：
            缺点1:太复杂，太乱，可读性差
...
public class Test01 {
    ...
    public void doOther(){
        // doSome方法中的局部内部类Inner3，在doOther中不能用
    }
