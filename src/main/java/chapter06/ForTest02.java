...
/*
	1、for循环的语法机制以及运行原理？
		...
		更新表达式的作用是：控制循环次数，换句话说，更新表达式会更新某个变量的值，
...
public class ForTest02 {
	public static void main(String[] args) {
		...
		/*
			...
			强调一下：对于以下的这个for循环，其中int i=0;最先执行，并且只执行一次，
			而且i变量属于for循环的局部变量，for循环结束之后i的内存就释放了，这个i变量只能在for循环中使用
			这个i变量属于for循环域，在main方法种没有办法直接使用
		*/
		for (int i=0; i<10; i++) {
