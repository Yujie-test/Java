	...
	switch语句：
		...
		2、switch语句的语法格式
			...
			switch语句支持的值有哪些？
				...
				switch语句本质上是只支持int和String，但是byte，short，char也可以使用在switch语句当中因为byte，short，char可以进行自动类型转换

				switch语句中“值”与”值1“、“值2”比较的时候会使用“==”进行比较

		3、switch语句的执行原理
			拿“值”与“值1”进行比较，如果相同，则执行该分支中的java语句，然后遇到“break;”语句，switch语句就结束了
			如果“值”与“值1”不想等，会继续拿“值”与“值2”进行比较，如果相同，则执行该分支中的java语句，然后遇到“break;”语句，switch结束
			注意：如果分支执行了，但是分支最后没有“break;”语句，此时会发生case穿透现象
